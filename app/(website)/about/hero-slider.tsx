...
export default function HeroSlider({
  ...
  return (
    <section className="relative w-full h-[55vh] sm:h-[55vh] md:h-[55vh] rounded-xl sm:rounded-2xl overflow-hidden pb-12 md:pb-16">
      {/* BACKGROUND SLIDES */}
      {images.map((img, i) => (
        <div key={img} className="absolute inset-0">
          <Image
            ...
            priority={i === 0}
            sizes="100vw"
            className={`object-cover object-center  rounded-xl sm:rounded-2xl md:object-[50%_20%] lg:object-[50%_25%] transition-all duration-700 ease-out will-change-transform ${
